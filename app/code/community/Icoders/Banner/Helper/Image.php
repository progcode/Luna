<?php
/**
 * app/code/community/Icoders/Banner/Helper/Image.php
 *
 * @category  Icoders
...
/**
 * Class Icoders_Banner_Helper_Image
 */
class Icoders_Banner_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
    ...
    /**
     * Return the base media directory for Banner Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Banner Item images
     *
     * @return string
     */
    ...
    /**
     * Remove banner item image by image filename
     *
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                Mage::throwException(Mage::helper('icoders_banner')->__('Uploaded image is not valid'));
            }
    ...
    /**
     * Return URL for resized Banner Item Image
     *
     * @param string  $imageFile item
